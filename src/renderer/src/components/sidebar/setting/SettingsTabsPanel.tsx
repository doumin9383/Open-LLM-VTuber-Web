...
interface SettingsTabsPanelProps {
  onSave?: (callback: () => void) => () => void;
  onCancel?: (callback: () => void) => () => void;
}

function SettingsTabsPanel({ onSave, onCancel }: SettingsTabsPanelProps): JSX.Element {
  ...
  return (
    ...
    >
      <Tabs.List {...settingStyles.settingUI.tabs.list}>
        ...
        <Tabs.Trigger value="agent" {...settingStyles.settingUI.tabs.trigger}>
